...
class ChannelManager:
    ...
    async def load(self, bot):
        ...
        resp = requests.post(url=f"https://aternos.org/panel/ajax/account/login.php?SEC={ajaxHelper.token}", data=arguments, headers=ajaxHelper.headers, cookies=ajaxHelper.cookies)
        #print(arguments)
